...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 508.0, 715.0, 88.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 376.0, 657.0, 29.5, 22.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 747.0, 459.0, 150.0, 20.0 ],
					"text" : "button mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 680.0, 501.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 681.0, 468.0, 44.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 778.0, 484.0, 150.0, 47.0 ],
					"text" : "<live.menu>\ninit =1  since it's zero indexed"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 676.0, 533.0, 100.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 681.0, 570.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 504.0, 468.0, 150.0, 33.0 ],
					"text" : "message will increase/decrease counter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 424.0, 468.0, 29.5, 22.0 ],
					"text" : "dec"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 469.75, 468.0, 29.5, 22.0 ],
					"text" : "inc"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 647.0, 150.0, 47.0 ],
					"text" : "counts number of times you press spacebar, for example"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 376.0, 720.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 376.5, 616.0, 425.0, 22.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 376.5, 435.0, 150.0, 22.0 ],
					"text" : "sel 32 28 29"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 431.0, 316.0, 296.0, 60.0 ],
					"text" : "returns ascii keycode\n32 == Spacebar (make this mean next event)\n28 == left arrow key (make this mean previous event)\n29 == right arrow (next event)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 376.5, 316.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 376.5, 268.0, 166.5, 22.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 139.0, 324.0, 150.0, 47.0 ],
					"text" : "can also load as an abstraction instead of a subpatch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 358.0, 116.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 324.0, 71.0, 22.0 ],
					"text" : "sound-in-v1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 600.083336929480311, 8.5, 244.0, 75.0 ],
					"viewvisibility" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 125.5, 243.0, 150.0, 47.0 ],
									"text" : "loadbangs can be finicky in a performance patch. so we will repace these"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 324.0, 202.0, 240.0, 20.0 ],
									"text" : "copied from midi.in.v01 patch"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 365.0, 385.0, 150.0, 33.0 ],
									"text" : "<umenu> Select the midi device"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 215.5, 572.0, 60.0, 22.0 ],
									"text" : "s channel"
								}
...
, 							{
								"box" : 								{
									"color" : [ 0.011764705882353, 0.2, 1.0, 1.0 ],
									"id" : "obj-16",
									"maxclass" : "newobj",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 149.0, 572.0, 58.0, 22.0 ],
									"text" : "s velocity"
								}
...
, 							{
								"box" : 								{
									"color" : [ 0.074509803921569, 0.407843137254902, 0.023529411764706, 1.0 ],
									"id" : "obj-15",
									"maxclass" : "newobj",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 82.5, 572.0, 43.0, 22.0 ],
									"text" : "s pitch"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 167.5, 528.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 96.0, 528.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 36.0, 528.0, 50.0, 22.0 ]
								}

							}
, 							{
								"box" : 								{
									"color" : [ 1.0, 0.929411764705882, 0.301960784313725, 1.0 ],
									"id" : "obj-8",
									"maxclass" : "newobj",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "int", "int" ],
									"patching_rect" : [ 82.5, 478.0, 152.0, 22.0 ],
									"text" : "notein"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 27.0, 385.0, 333.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 27.0, 327.0, 50.0, 22.0 ],
									"text" : "midiinfo"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 28.0, 283.0, 64.0, 22.0 ],
									"text" : "controllers"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 28.0, 202.0, 150.0, 33.0 ],
									"text" : "Receive midi info from a keyboard in max"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 28.0, 243.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 12.0, 157.0, 24.0, 24.0 ]
								}

							}
, 							{
								"box" : 								{
									"color" : [ 0.850980392156863, 0.180392156862745, 0.905882352941176, 1.0 ],
									"id" : "obj-42",
									"maxclass" : "newobj",
									"numinlets" : 0,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 222.5, 151.0, 80.0, 22.0 ],
									"text" : "r current.path"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 517.0, 146.5, 82.0, 22.0 ],
									"text" : "s current.path"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 46.0, 151.0, 106.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 108.5, 188.0, 150.0, 33.0 ],
									"text" : "<= inlet stores a list (right), bang it out later (left)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 49.0, 188.0, 38.0, 22.0 ],
									"text" : "zl reg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 622.0, 104.5, 279.0, 49.0 ],
									"text" : "\"Macintosh HD:/Users/josephlee/Documents/Max Course/sound-synth-tech/Week 14/magnum.opus.boiler/\""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 469.0, 19.0, 59.0, 22.0 ],
									"text" : "r get.path"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 528.0, 48.0, 32.0, 22.0 ],
									"text" : "path"
								}
...
, 							{
								"box" : 								{
									...
									"prefix" : "~/Documents/Max Course/sound-synth-tech/Week 14/magnum.opus.boiler/media/"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 18.0, 298.0, 158.0, 49.0 ],
													"text" : ";\rpring.high.ms 200;\rprinter.thingy \"...even faster\""
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 18.0, 228.0, 67.0, 22.0 ],
													"text" : "delay 3000"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 634.5, 233.0, 240.0, 49.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 634.5, 198.099853499999995, 252.0, 20.0 ],
													"text" : "1. faster pinging",
													"textcolor" : [ 0.011765, 0.396078, 0.752941, 1.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 18.0, 155.0, 581.5, 22.0 ],
													"text" : "b 2"
												}
...
,
									"patching_rect" : [ 226.136363636363626, 247.0, 25.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 18.0, 298.0, 181.0, 35.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 18.0, 228.0, 74.0, 22.0 ],
													"text" : "delay 10000"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 634.5, 233.0, 206.0, 62.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 0,
													"patching_rect" : [ 634.5, 198.099853499999995, 252.0, 20.0 ],
													"text" : "1. Start process and gradually fade in",
													"textcolor" : [ 0.011765, 0.396078, 0.752941, 1.0 ]
												}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 18.0, 248.0, 267.0, 102.0 ],
													"presentation_linecount" : 6,
													"text" : ";\rprinter.thingy \"Sending initial ping values...\";\rping.low.ms 100;\rping.high.ms 900;\rping.click.gain 23.;\rprinter.thingy \"INIT complete ready for event #1\";\r"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 328.5, 248.0, 287.0, 76.0 ],
													"presentation_linecount" : 6,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 634.5, 233.0, 240.0, 129.0 ],
													"text" : ";\rprinter.thingy \"Starting INIT process...\";\rdsp iovs 1024;\rdsp sigvs 512;\rdsp takeover 0;\rdsp cpulimit 0;\rdsp sr 48000;\rprinter.thingy \"DSP settings have been set\";\r"
												}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 132.666670262813568, 494.0, 101.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 37.0, 538.0, 78.0, 22.0 ],
									"text" : "lg.vol.util.v01"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 37.0, 313.0, 67.0, 22.0 ],
									"text" : "lg.ping.v02"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 37.0, 579.000008523464203, 61.0, 22.0 ],
									"text" : "send~ in1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "", "float", "list" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 37.0, 380.0, 48.0, 136.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 363.0, 13.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 998.0, 221.0, 150.0, 33.0 ],
									"text" : "from spat boiler in week 11"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 461.246673583984375, 340.5, 150.0, 33.0 ],
									"text" : "option click to bring up help files"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 56.0, 167.0, 150.0, 47.0 ],
													"text" : "A bay of audio jacks to save space in our main patch"
												}

											}
, 											{
												"box" : 												{
													"color" : [ 0.807843137254902, 0.870588235294118, 0.062745098039216, 1.0 ],
													"id" : "obj-16",
													"maxclass" : "newobj",
													"numinlets" : 1,
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 659.0, 47.0, 74.0, 22.0 ],
													"text" : "receive~ in8"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 659.0, 102.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 577.0, 47.0, 74.0, 22.0 ],
													"text" : "receive~ in7"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 577.0, 102.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 494.0, 47.0, 74.0, 22.0 ],
													"text" : "receive~ in6"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 494.0, 102.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 406.0, 47.0, 74.0, 22.0 ],
													"text" : "receive~ in5"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 406.0, 102.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 314.0, 47.0, 74.0, 22.0 ],
													"text" : "receive~ in4"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 228.0, 47.0, 74.0, 22.0 ],
													"text" : "receive~ in3"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 228.0, 102.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 145.0, 47.0, 74.0, 22.0 ],
													"text" : "receive~ in2"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 145.0, 102.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 56.0, 47.0, 74.0, 22.0 ],
													"text" : "receive~ in1"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 56.0, 102.0, 30.0, 30.0 ]
												}
...
,
									"patching_rect" : [ 30.999999999999943, 251.0, 432.000000000000057, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 573.746673583984375, 375.5, 149.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 31.0, 623.5, 380.375, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 9,
									"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "" ],
									"patching_rect" : [ 31.0, 375.5, 432.0, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 876.963363647460938, 230.5, 91.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 876.963363647460938, 278.5, 136.0, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 114.666670262813568, 880.0, 68.0, 22.0 ],
									"text" : "send~ out2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 31.0, 880.0, 68.0, 22.0 ],
									"text" : "send~ out1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "signal", "", "float", "list" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 31.0, 726.0, 200.0, 116.0 ],
									"relative" : 1,
									"saved_attribute_attributes" : 									{
										"focusbordercolor" : 										{
											"expression" : ""
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-14", 0 ],
									"midpoints" : [ 886.463363647460938, 337.5, 40.5, 337.5 ],
									"source" : [ "obj-11", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"color" : [ 0.184063136577606, 0.16844055056572, 0.734357416629791, 1.0 ],
									"destination" : [ "obj-23", 0 ],
									"midpoints" : [ 583.246673583984375, 444.0, 40.5, 444.0 ],
									"source" : [ "obj-7", 0 ]
								}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-7" : [ "live.gain~[3]", "ping", 0 ],
...
, 			{
				...
				"bootpath" : "~/Documents/Max Course/sound-synth-tech/Week 14/magnum.opus.boiler",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}

...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1065.5, 605.5, 150.0, 33.0 ],
					"text" : "changing the aperture - 80. is default"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1031.0, 611.0, 29.5, 22.0 ],
					"text" : "80."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1031.0, 644.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1031.0, 686.5, 219.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 948.779983520507812, 862.5, 152.0, 60.0 ],
					"text" : "can click \"mute ambience\" to toggle reverb on/off and also edit it within the viewer R1 (room) tab"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 991.0, 60.5, 150.0, 33.0 ],
					"text" : "/dump to follow syntax because it's osc"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 994.216690063476562, 95.5, 42.0, 22.0 ],
					"text" : "/dump"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 854.963363647460938, 240.5, 150.0, 47.0 ],
					"text" : "spat5.osc.view - interface object to see what's happening"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1006.963363647460938, 234.0, 196.0, 149.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 605.0, 86.0, 150.0, 33.0 ],
					"text" : "ways to change different kinds of panning"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 499.246673583984375, 86.0, 100.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 500.746673583984375, 116.0, 97.0, 22.0 ],
					"text" : "/panning/type $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 474.246673583984375, 205.5, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 494.375, 488.5, 153.0, 114.0 ],
					"text" : "In class, LG used an additional patch that had 8 inlets and then send~ out1 thru 8 (basically copy receive.all.sources and reverse it. you'd delete the send~out1 and out2 in the headphones livegain"
				}
...
,
					"patching_rect" : [ 43.999999999999943, 116.0, 432.000000000000057, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 586.746673583984375, 240.5, 149.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 44.0, 488.5, 380.375, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 658.746673583984375, 422.5, 150.0, 20.0 ],
					"text" : "live.gain with 8 channels"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "" ],
					"patching_rect" : [ 44.0, 240.5, 432.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1038.216690063476562, 105.5, 153.0, 114.0 ],
					"text" : "click the gear in the rightside top left corner to change the Z axis coordinates as well\n\nClick the R1 tab to see the reverb tab (reverb room)\n"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 889.963363647460938, 95.5, 91.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 889.963363647460938, 143.5, 136.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 314.0, 786.5, 119.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 44.0, 817.5, 120.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 172.0, 786.5, 140.0, 60.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 172.0, 854.5, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.0, 854.5, 82.0, 22.0 ],
					"text" : "/preset/export"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 894.5, 93.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 818.746673583984375, 833.0, 60.0, 20.0 ],
					"text" : "<live.tex>"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 864.779983520507812, 544.0, 179.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 864.779983520507812, 507.0, 268.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 127.666670262813568, 745.0, 68.0, 22.0 ],
					"text" : "send~ out2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 44.0, 745.0, 68.0, 22.0 ],
					"text" : "send~ out1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 864.779983520507812, 403.5, 393.0, 87.0 ],
...
,
					"patching_rect" : [ 540.746673583984375, 815.0, 152.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 438.746673583984375, 894.5, 151.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 455.963363647460938, 805.5, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 541.746673583984375, 781.5, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 704.746673583984375, 807.5, 99.0, 20.0 ],
					"text" : "some controls —"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 704.746673583984375, 835.5, 112.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 487.963363647460938, 861.5, 29.5, 22.0 ],
					"text" : "/hrtf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 455.963363647460938, 831.5, 41.0, 21.0 ],
					"text" : "kemar"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 438.746673583984375, 861.5, 46.0, 22.0 ],
					"text" : "/hrtf $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 438.746673583984375, 781.5, 101.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
,
					"patching_rect" : [ 520.746673583984375, 861.5, 57.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 11.0,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 44.0, 591.0, 200.0, 116.0 ],
					"relative" : 1,
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 704.746673583984375, 861.5, 237.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 764.746673583984375, 666.5, 164.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 704.746673583984375, 666.5, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 467.033309936523381, 374.5, 321.0, 116.0 ],
					"relative" : 1,
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_meter_bg"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 704.746673583984375, 695.5, 224.0, 102.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 465.463363647460938, 857.5, 448.246673583984375, 857.5 ],
					"source" : [ "obj-101", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 530.246673583984375, 889.5, 448.246673583984375, 889.5 ],
					"source" : [ "obj-105", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 414.875, 360.0, 778.533309936523438, 360.0 ],
					"order" : 0,
					"source" : [ "obj-14", 7 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 363.25, 360.0, 735.390452793666213, 360.0 ],
					"order" : 0,
					"source" : [ "obj-14", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 311.625, 360.0, 692.247595650809103, 360.0 ],
					"order" : 0,
					"source" : [ "obj-14", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 260.0, 360.0, 649.104738507951993, 360.0 ],
					"order" : 0,
					"source" : [ "obj-14", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 208.375, 360.0, 605.961881365094769, 360.0 ],
					"order" : 0,
					"source" : [ "obj-14", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 156.75, 360.0, 562.819024222237658, 360.0 ],
					"order" : 0,
					"source" : [ "obj-14", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 105.125, 360.0, 519.676167079380548, 360.0 ],
					"order" : 0,
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 53.5, 360.0, 476.533309936523381, 360.0 ],
					"order" : 0,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 899.463363647460938, 202.5, 53.5, 202.5 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-23", 0 ],
					"midpoints" : [ 596.246673583984375, 309.0, 53.5, 309.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 497.463363647460938, 889.5, 448.246673583984375, 889.5 ],
					"source" : [ "obj-99", 0 ]
				}

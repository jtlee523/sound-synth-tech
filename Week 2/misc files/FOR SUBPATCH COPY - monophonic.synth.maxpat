...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 620.0, 415.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					"addpoints" : [ 21.276595744680851, 0.093333333333333, 0, 223.404255319148945, 0.84, 0, 367.021276595744666, 0.413333333333333, 0, 601.063829787233999, 0.4, 0, 920.212765957446777, 0.013333333333333, 2 ],
					"id" : "obj-37",
					"maxclass" : "function",
					"numinlets" : 1,
					"numoutlets" : 4,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 402.666666666666629, 383.0, 200.0, 100.0 ]
				}
